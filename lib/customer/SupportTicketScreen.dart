...
class BrandSupportTicketScreen extends StatefulWidget {
  const BrandSupportTicketScreen({Key? key}) : super(key: key);

  @override
  _BrandSupportTicketScreenState createState() => _BrandSupportTicketScreenState();
}

class _BrandSupportTicketScreenState extends State<BrandSupportTicketScreen> {
  ...
  Future<void> fetchUserData(String u_id) async {
    final String getBasicDetailsApi = "https://demo.infoskaters.com/api/get_brand_basic.php?u_id=$u_id";
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          _mobileController.text = data['mob'] ?? '';
        });
      } else {
