...
import 'package:tngtong/celebrities/loginScreen.dart' as celebrities;
      ...
      onPressed: () {
        ...
        if (type == 'Influencer') {
          Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    celebrities.loginScreen()), // Navigate to the businessman screen, if it's the same, then it's ok.
          );
...
Widget _buildButton(double screenWidth, String text, Gradient gradient,
